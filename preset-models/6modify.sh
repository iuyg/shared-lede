...
#修改固件大小、复制闪存布局文件
sed -i '/Device\/jdcloud_re-cp-02/,/Mi Router 4A/ s/14848k/15808k/' target/linux/ramips/image/mt7621.mk
sed -i '/Device\/jdcloud_re-cp-02/,/mir3g-v2/ s/14848k/15080k/' target/linux/ramips/image/mt7621.mk
